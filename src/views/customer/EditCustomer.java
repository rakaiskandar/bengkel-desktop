...
public class EditCustomer extends javax.swing.JFrame {
    ...
    private void loadData(int id) {
        ...
        Customer cs = service.getCustomerById(id);
        if (cs != null) {
            jTextField2.setText(cs.getName());
            jTextField1.setText(cs.getPhone());
        } else {
            JOptionPane.showMessageDialog(this, "Data Customer tidak ditemukan.", "Error", JOptionPane.ERROR_MESSAGE);
            dispose();
        }
    }
    ...
    private void saveData() {
        ...
        try {
            ...
            cs.setId(customerId);
            cs.setName(name);
            cs.setPhone(phoneStr);

            CustomerService service = new CustomerService();
            boolean success = service.updateCustomer(cs);
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Edit Customer");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(330, 110, 180, 80);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditCustomer view = new EditCustomer();
